 ...
 */
public class EventThreadGenerator extends AbstractGeneratorC {
...
//            + "#include \"functionclosure.h\"\n"
  ...
  public static void printDeclarationsLogic()
  {
    ...
    out.getWriter(M_LOGIC_CPP).println("typedef struct { // args for event_handler()\n");
    out.getWriter(M_LOGIC_CPP).println("\tbool *running;");
    out.getWriter(M_LOGIC_CPP).println("\tbool bootStrap;");
    out.getWriter(M_LOGIC_CPP).println("\tint currentQueueIndex;");
    out.getWriter(M_LOGIC_CPP).println("}event_handler_args_t;\n");
