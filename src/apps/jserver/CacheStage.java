...
public class CacheStage implements EventHandlerIF {
...
public void handleEvent(QueueElementIF item) {if (item instanceof SedaWrapper) {SedaWrapper sw = (SedaWrapper)item;Event e = sw.getEvent();CacheImpl in = (CacheImpl)e.getData();in.execute();int nxt = e.pop();if (nxt != -1) {
