...
public class XSLTStage implements EventHandlerIF {
...
public void handleEvent(QueueElementIF item) {if (item instanceof SedaWrapper) {SedaWrapper sw = (SedaWrapper)item;Event e = sw.getEvent();XSLTImpl in = (XSLTImpl)e.getData();in.execute();int nxt = e.pop();if (nxt != -1) {
